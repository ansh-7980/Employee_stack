 ...
 ?>
        ...
        <div class="logo_content">
            <div class="logo">
                <div class="logo_name text-center">
                    <img src="../images/<?php if(!empty($dp)){ echo $dp; }else{ echo "logo.png"; } ?>" alt="" class="img-fluid">
                </div>
            </div>
    ...
    <div class="container">
        <div class="card m-auto w-50" style="width: 18rem;">
            <img class="card-img-top" src="../images/<?php if(!empty($dp)){ echo $dp; }else{ echo "logo.png"; } ?>" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title text-center"><?php echo $name; ?></h5>
            </div>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">Email : <?php echo $_SESSION["email_emp"] ?> </li>
                ...
                <li class="list-group-item">Salary : <?php echo $salary . " Rs."; ?></li>
