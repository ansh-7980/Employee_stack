...
<html lang="en">
 ...
 ?>
        ...
        <table style="width:100%;" class="table table-hover text-center table-info ">
        <thead>
        <tr>
    ...
    if( mysqli_num_rows($result) > 0){
        ...
        <td>  <?php 
                $edit_icon = "<a href='editemployee.php?id= {$id}' class='btn-sm  '> <span ><i class='bx bx-edit-alt'></i></span> </a>";
                $delete_icon = " <a href='deleteemployee.php?id={$id}' id='bin' class='btn-sm'> <span ><i class='bx bx-trash'></i></span> </a>";
