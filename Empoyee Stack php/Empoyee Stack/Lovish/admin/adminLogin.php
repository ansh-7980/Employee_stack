 ...
 <!-- php script end -->
    ...
    <div class="container text-dark py-5 my-5">
        <div class="p-5 m-5 main">
            ...
            <h4 class="py-2 text-center"> Login As Admin </h4>
            <form method="POST" action=" <?php htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                <div class="form-group row">
                    ...
                    <div class="form-group">
                        ...
                        <p class="mt-4">Not an Admin <a href="../employee/employeeLogin.php" style="background-color: white;">Login</a> As Employee.</p>
                    </div>
