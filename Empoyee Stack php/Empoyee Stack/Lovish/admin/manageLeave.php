...
?>
        ...
        <h2 class="text-white py-3">Leave Requests</h2>
    ...
    if( mysqli_num_rows($result) > 0){
        ...
        <td><?php  echo "<a href='acceptleave.php?id={$id}' class='btn btn-sm btn-outline-primary mr-2'>Accept </a>" ;
                    echo "<a href='cancelleave.php?id={$id}' class='btn btn-sm btn-outline-danger'>Cancel </a>" ;?>  
        </td> 
